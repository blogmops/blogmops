...
const css = {
	code: ".posts.svelte-p87h3e.svelte-p87h3e{display:grid;grid-template-columns:1fr 1fr;grid-gap:2rem}.post.svelte-p87h3e.svelte-p87h3e{cursor:pointer;text-decoration:none}.post.svelte-p87h3e .image.svelte-p87h3e{height:12rem;border-radius:5px;margin:15px 0;object-fit:cover;width:100%;border-radius:10px;box-shadow:0 4px 20px rgba(150, 150, 150, 0.25);-webkit-box-shadow:0 4px 20px rgba(150, 150, 150, 0.25);transition:250ms ease-in all}.post.svelte-p87h3e h2.svelte-p87h3e{margin:0;padding:0 0.5rem;font-size:1.25rem;font-weight:600}.post.svelte-p87h3e .description.svelte-p87h3e{padding:0.5rem;opacity:0.4}.post.svelte-p87h3e:hover .image.svelte-p87h3e{box-shadow:0 4px 20px rgba(100, 100, 100, 0.25);-webkit-box-shadow:0 4px 20px rgba(100, 100, 100, 0.25);transform:translateY(-2px)}@media(max-width: 767px){.posts.svelte-p87h3e.svelte-p87h3e{grid-template-columns:1fr}.post.svelte-p87h3e.svelte-p87h3e:nth-child(4n+1),.post.svelte-p87h3e.svelte-p87h3e:nth-child(4n+2),.post.svelte-p87h3e.svelte-p87h3e:nth-child(4n+3),.post.svelte-p87h3e.svelte-p87h3e:nth-child(4n+4){grid-column:span 1}}",
...
const Posts = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  ${each(postsToDisplay, post => `<a class="${"post svelte-p87h3e"}" href="${"/blog/" + escape(post.slug)}">
	...
	? `<img${add_attribute("src", post.frontmatter.preview, 0)} class="${"image svelte-p87h3e"}"${add_attribute("alt", post.frontmatter.title, 0)}>`
	: ``}
...
<div class="${"container svelte-10h0ygf"}">
  ...
  <img${add_attribute("src", post.frontmatter.preview, 0)} class="${"image"}"${add_attribute("alt", post.frontmatter.title, 0)}>
...
${validate_component(Posts, "Posts").$$render($$result, { posts, limit: 2 }, {}, {})}
...
const css$6 = {
	code: "nav.svelte-yyy3zq.svelte-yyy3zq{display:flex;flex-flow:row wrap;align-items:center;justify-content:space-between;padding:4rem 0 2rem;width:50%;margin:0 auto}.logo.svelte-yyy3zq.svelte-yyy3zq{font-size:1.2rem}.logo.svelte-yyy3zq span.svelte-yyy3zq{font-weight:bold}ul.svelte-yyy3zq.svelte-yyy3zq{margin:0;padding:0}ul.svelte-yyy3zq.svelte-yyy3zq::after{content:\"\";display:block;clear:both}ul.svelte-yyy3zq li.svelte-yyy3zq{display:block;float:left}.selected.svelte-yyy3zq.svelte-yyy3zq{position:relative;display:inline-block}.selected.svelte-yyy3zq.svelte-yyy3zq::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:#ff3e00;display:block;bottom:-1px}a.svelte-yyy3zq.svelte-yyy3zq{text-decoration:none;padding:1em 0.5em;display:block}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n  export let segment;\\n</script>\\n\\n<style lang=\\\"scss\\\">nav {\\n  display: flex;\\n  flex-flow: row wrap;\\n  align-items: center;\\n  justify-content: space-between;\\n  padding: 4rem 0 2rem;\\n  width: 50%;\\n  margin: 0 auto;\\n}\\n\\n.logo {\\n  font-size: 1.2rem;\\n}\\n.logo span {\\n  font-weight: bold;\\n}\\n\\nul {\\n  margin: 0;\\n  padding: 0;\\n  /* clearfix */\\n}\\nul::after {\\n  content: \\\"\\\";\\n  display: block;\\n  clear: both;\\n}\\nul li {\\n  display: block;\\n  float: left;\\n}\\n\\n.selected {\\n  position: relative;\\n  display: inline-block;\\n}\\n.selected::after {\\n  position: absolute;\\n  content: \\\"\\\";\\n  width: calc(100% - 1em);\\n  height: 2px;\\n  background-color: #ff3e00;\\n  display: block;\\n  bottom: -1px;\\n}\\n\\na {\\n  text-decoration: none;\\n  padding: 1em 0.5em;\\n  display: block;\\n}\\n\\n/*# sourceMappingURL=Nav.svelte.css.map */</style>\\n\\n<nav>\\n  <a href=\\\".\\\" class=\\\"logo\\\">\\n    <span>Stunning</span>\\n    theme\\n  </a>\\n  <ul>\\n    <!-- <li><a class:selected={segment === undefined} href=\\\".\\\">home</a></li> -->\\n    <li>\\n      <a class:selected={segment === 'about'} href=\\\"about\\\">About</a>\\n    </li>\\n    <li>\\n      <a class:selected={segment === 'contact'} href=\\\"contact\\\">Contact</a>\\n    </li>\\n\\n    <!-- for the blog link, we're using rel=prefetch so that Sapper prefetches\\n\\t\\t     the blog data when we hover over the link or tap it on a touchscreen -->\\n    <!-- <li><a rel=prefetch class:selected='{segment === \\\"blog\\\"}' href='blog'>blog</a></li> -->\\n  </ul>\\n</nav>\\n\"],\"names\":[],\"mappings\":\"AAImB,GAAG,4BAAC,CAAC,AACtB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,GAAG,CAAC,IAAI,CACnB,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAC9B,OAAO,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CACpB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,SAAS,CAAE,MAAM,AACnB,CAAC,AACD,mBAAK,CAAC,IAAI,cAAC,CAAC,AACV,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,AAEZ,CAAC,AACD,8BAAE,OAAO,AAAC,CAAC,AACT,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,AACb,CAAC,AACD,gBAAE,CAAC,EAAE,cAAC,CAAC,AACL,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,SAAS,4BAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,AACvB,CAAC,AACD,qCAAS,OAAO,AAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CACvB,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,CAAC,4BAAC,CAAC,AACD,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,GAAG,CAAC,KAAK,CAClB,OAAO,CAAE,KAAK,AAChB,CAAC\"}"
};
...
const css$7 = {
	code: "footer.svelte-1pxwni3.svelte-1pxwni3{display:flex;justify-content:center;padding:4rem 0 2rem;width:100%;flex-flow:row nowrap}footer.svelte-1pxwni3 .copyright.svelte-1pxwni3{opacity:0.5}",
	map: "{\"version\":3,\"file\":\"Footer.svelte\",\"sources\":[\"Footer.svelte\"],\"sourcesContent\":[\"<style lang=\\\"scss\\\">footer {\\n  display: flex;\\n  justify-content: center;\\n  padding: 4rem 0 2rem;\\n  width: 100%;\\n  flex-flow: row nowrap;\\n}\\nfooter .copyright {\\n  opacity: 0.5;\\n}\\n\\n/*# sourceMappingURL=Footer.svelte.css.map */</style>\\n\\n<footer>\\n  <span class=\\\"copyright\\\">Copyright &copy; 2022 . blogops</span>\\n</footer>\\n\"],\"names\":[],\"mappings\":\"AAAmB,MAAM,8BAAC,CAAC,AACzB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,OAAO,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CACpB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,GAAG,CAAC,MAAM,AACvB,CAAC,AACD,qBAAM,CAAC,UAAU,eAAC,CAAC,AACjB,OAAO,CAAE,GAAG,AACd,CAAC\"}"
};
