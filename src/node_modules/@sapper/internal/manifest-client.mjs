...
export const ignore = [/^\/index.json$/, /^\/blog\/([^\/]+?).json$/, /^\/([0-9]+).json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/[page([0-9]+)].svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:[page([0-9]+)].svelte__"
	}
];
...
if (typeof window !== 'undefined') {
	import("C:/Users/andre/Workspace/blogmops/node_modules/sapper/sapper-dev-client.js").then(client => {
